...
return [
    ...
    */
    ...
    'sharepoint' => [
        ...
        'enlaces_folder_id'   => env('SHAREPOINT_ENLACES_FOLDER_ID'),
        'enlaces_site_url'    => env('SHAREPOINT_ENLACES_SITE_URL'),
        'enlaces_folder_path' => env('SHAREPOINT_ENLACES_FOLDER_PATH'),
