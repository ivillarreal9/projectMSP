<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-xl font-bold text-gray-800 dark:text-gray-100">Nuevo Registro META 2</h2>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Completa el formulario para crear un nuevo registro.</p>
            </div>
    ...
    <div class="py-8">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                ...
                <form action="{{ route('admin.meta-2.store') }}" method="POST" class="p-6 sm:p-8">
                    @csrf
                    ...
                    <div class="mb-6">
                        ...
                        <textarea id="descripcion" name="descripcion" rows="3"
                                  ...
                                  placeholder="Agregue una descripción (opcional)">{{ old('descripcion') }}</textarea>
                        @error('descripcion')
                            <p class="text-red-500 text-xs mt-1.5 flex items-center gap-1">
                                <svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M18.101 12.93a1 1 0 00-1.414-1.414L9 16.586 6.313 13.9a1 1 0 00-1.414 1.413l3.414 3.414a1 1 0 001.414 0l9.9-9.9z" clip-rule="evenodd"/></path></svg>
                                {{ $message }}
                    ...
                    <div class="mb-6">
                        ...
                        <textarea id="valor" name="valor" rows="4"
                                  ...
                                  placeholder="Ingrese el valor del registro">{{ old('valor') }}</textarea>
                        @error('valor')
                            <p class="text-red-500 text-xs mt-1.5 flex items-center gap-1">
                                <svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M18.101 12.93a1 1 0 00-1.414-1.414L9 16.586 6.313 13.9a1 1 0 00-1.414 1.413l3.414 3.414a1 1 0 001.414 0l9.9-9.9z" clip-rule="evenodd"/></path></svg>
                                {{ $message }}
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <label class="flex items-center p-3 border-2 border-gray-200 dark:border-gray-600 rounded-lg cursor-pointer transition hover:border-indigo-500 @error('estado') border-red-500 @enderror"
                                ...
                                <input type="radio" name="estado" value="activo" {{ old('estado') === 'activo' ? 'checked' : '' }}
