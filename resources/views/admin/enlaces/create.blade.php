<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h2 class="text-xl font-bold text-gray-800 dark:text-gray-100">Nuevo Enlace</h2>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Registra una nueva URL en el sistema</p>
            </div>
        </div>
    </x-slot>
    ...
    <div class="py-10">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-6">
                ...
                <form method="POST" action="{{ route('admin.enlaces.store') }}" x-data="{ categoriaPersonalizada: false }">
                    @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="descripcion" rows="3"
                                  class="w-full text-sm border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none"
                                  placeholder="Descripción opcional del enlace">{{ old('descripcion') }}</textarea>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input x-show="categoriaPersonalizada" type="text" name="categoria" value="{{ old('categoria') }}"
